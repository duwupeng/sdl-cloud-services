...
public interface SmsTemplateMapper {
    ...
    @SelectProvider(type = NotifyTemplateSqlProvider.class, method = "querySystemTemplates")
    List<TNotifyTemplate> querySystemTemplates(@Param("companyId") Integer companyId, @Param("creator") String creator);
    ...
    @UpdateProvider(type = NotifyTemplateSqlProvider.class, method = "updateSms")
    Integer updateSms(TNotifyTemplate tNotifyTemplate);
