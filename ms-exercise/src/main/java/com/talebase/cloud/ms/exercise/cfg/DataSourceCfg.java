package com.talebase.cloud.ms.exercise.cfg;
...
public class DataSourceCfg {
    ...
    @Bean(name="adminDs")
//    @Primary
    @ConfigurationProperties(prefix="datasource.paper")
    public DataSource userDataSource(@Value("${datasource.paper.type}") String clazName) throws ClassNotFoundException {
