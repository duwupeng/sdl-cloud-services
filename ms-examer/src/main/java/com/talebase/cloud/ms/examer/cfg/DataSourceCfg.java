...
public class DataSourceCfg {
    ...
    @Bean(name="examerDs")
//    @Primary
    @ConfigurationProperties(prefix="datasource.examer")
    public DataSource userDataSource(@Value("${datasource.examer.type}") String clazName) throws ClassNotFoundException {
