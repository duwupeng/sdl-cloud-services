package com.talebase.cloud.ms.project.conf;
...
//    @Primary
    ...
    public DataSource userDataSource(@Value("${datasource.project.type}") String clazName) throws ClassNotFoundException {
